...
def ensure_optional_service_tfvars(tfvars_lines: list[str], optional_services: set[str]) -> list[str]:
    ...
    if "searxng_onramp" in optional_services:
        defaults.update({
            ...
            "searxng_container_image": hcl_quote("docker.io/searxng/searxng@sha256:f433294b46a93564993c4371005341e013d94aa8ea4662d8ee521cd2cccb08e8"),
...
def ensure_inventory_vars(path: Path, text: str, domain: str) -> tuple[str, list[str]]:
    ...
    additions = {
        ...
        "infisical_version": "    infisical_version: v0.162.3@sha256:75e74ee1cc11bdc1b504acb9846940484501ce3f1c54cb3af77cdd09a6c05893",
        ...
        "searxng_container_image": "    searxng_container_image: docker.io/searxng/searxng@sha256:f433294b46a93564993c4371005341e013d94aa8ea4662d8ee521cd2cccb08e8",
